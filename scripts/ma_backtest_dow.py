"""
Script 1 — MA Crossover Backtest on DJIA Index (^DJI)

Tests moving average crossover strategies on the Dow Jones Industrial Average.
...
Outputs:
  ...
  - ../outputs/ma_backtest_dow_results.csv
  - ../outputs/ma_backtest_dow_chart.png
"""
...
CSV_PATH = os.path.join(OUTPUT_DIR, 'ma_backtest_dow_results.csv')
CHART_PATH = os.path.join(OUTPUT_DIR, 'ma_backtest_dow_chart.png')
...
def main():
    ...
    # ---------------------------------------------------------------------------
    print("\n" + "=" * 90)
    print("DJIA MA CROSSOVER BACKTEST — SUMMARY")
    ...
    ax_price.set_title(f'^DJI Price with Representative SMAs', fontsize=11, fontweight='bold', pad=8)
    ...
    fig.suptitle('DJIA MA Crossover Backtest — Script 1', fontsize=14,
